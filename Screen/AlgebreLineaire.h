...
template<class T>
inline double cos (const T &u1, const T &u2)
{ return (u1 * u2) / (norme(u1) * norme(u2)); }
...
/*
 * D�finit un couple de valeurs o� les 2 valeurs ne sont pas forc�ment de m�me nature
 *
 * */
...
public:
    ...
    friend ostream &operator<< (ostream &o, const Paire<S, T> &paire)
    { return o << (string) paire; }
